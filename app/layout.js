...
export const metadata = {
  ...
  description:
    "Sadekul Islam (Lì Ào) is a Software Engineering student in China building AI-powered gesture control and computer vision systems using React and Python. Creator of the Lì Ào Engine.",
  keywords: [
    "Sadekul Islam",
    "Sadekul Islam Sadik",
    "Lì Ào",
